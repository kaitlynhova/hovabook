...
class GigsControllerTest < ActionController::TestCase
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post :create, gig: { date: @gig.date, instructions: @gig.instructions, location: @gig.location, payment: @gig.payment, payment_schedule: @gig.payment_schedule, songs: @gig.songs }
    end
  ...
  test "should update gig" do
    put :update, id: @gig, gig: { date: @gig.date, instructions: @gig.instructions, location: @gig.location, payment: @gig.payment, payment_schedule: @gig.payment_schedule, songs: @gig.songs }
    assert_redirected_to gig_path(assigns(:gig))
  end
